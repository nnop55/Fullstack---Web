...
import { tokenIsInBlacklist, verifyToken } from "../middleware/token-middleware";
...
export class AuthRouter {
    ...
    private initRoutes() {
        ...
        this.router.post('/logout', verifyToken, tokenIsInBlacklist, (req, res) => this.authController.logout(req, res));
        this.router.post('/verify-email', validateEmailInput, (req, res) => this.authController.sentCodeToEmail(req, res));
        this.router.get('/get-users', verifyToken, tokenIsInBlacklist, (req, res) => this.authController.getUsers(req, res));
